...
export function DashboardPage() {
  ...
  // Get real metrics from pipeline data
  const metrics = useMemo(() => getDashboardMetrics(), []);

  // Get project-specific metrics for featured project
  const featuredProject = mockProjects[0]; // Wallace Historic Restoration
  const featuredProjectMetrics = useMemo(
    () => getProjectMetrics(featuredProject.id),
    [featuredProject.id]
  );
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <div className="bg-white border border-neutral-200 p-5">
          ...
          <p className="text-xs text-neutral-500 mt-1">
            {metrics.inProgressCount + metrics.awaitingApprovalCount} work orders in pipeline
          </p>
        </div>
        ...
        <div className="bg-white border border-neutral-200 p-5">
          ...
          <p className="text-2xl font-bold text-neutral-900">{metrics.inProgressCount}</p>
        ...
        <div className="bg-white border border-neutral-200 p-5">
          ...
          <p className="text-2xl font-bold text-neutral-900">{metrics.awaitingApprovalCount}</p>
        ...
        <div className="bg-white border border-neutral-200 p-5">
          ...
          <p className="text-2xl font-bold text-neutral-900">{metrics.completedCount}</p>
              ...
              {filteredWorkOrders.map((wo) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-3 px-4">
                      <span className={`text-xs px-2 py-0.5 font-medium ${getPriorityColor(wo.priority)}`}>
                        {wo.priority}
                      </span>
                    </td>
                    <td className="py-3 px-4">
        ...
        <div className="bg-white border border-neutral-200 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs px-2 py-0.5 bg-red-100 text-red-700 font-medium">
              {metrics.blockedCount + metrics.awaitingApprovalCount}
            </span>
          </div>
          ...
          <div className="space-y-3">
            ...
            {metrics.blockedCount + metrics.awaitingApprovalCount === 0 && (
              <div className="text-center py-8 text-neutral-500">
